@echo off
REM build_ogre_Visual_Studio_17_2022_x64.bat file below:
SETLOCAL
...
set PLATFORM=x64
set CMAKE_BIN_x64="D:\AProgs\CMake\bin\cmake.exe"

IF EXIST %CMAKE_BIN_x64% (
	echo CMake 64-bit detected
	set CMAKE_BIN=%CMAKE_BIN_x64%
) ELSE (
	echo Cannot detect either CMake. Make sure CMake is installed
	EXIT /B 1
)
